 ...
 *       See {@link com.zlp.std.In} for an object-oriented version that handles
 ...
 *       for consistency with {@link com.zlp.std.StdOut}, {@link Double#parseDouble(String)},
...
public final class StdIn {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        com.zlp.std.StdOut.print("Type a string: ");
        String s = StdIn.readString();
        com.zlp.std.StdOut.println("Your string was: " + s);
        com.zlp.std.StdOut.println();

        com.zlp.std.StdOut.print("Type an int: ");
        int a = StdIn.readInt();
        com.zlp.std.StdOut.println("Your int was: " + a);
        com.zlp.std.StdOut.println();

        com.zlp.std.StdOut.print("Type a boolean: ");
        boolean b = StdIn.readBoolean();
        com.zlp.std.StdOut.println("Your boolean was: " + b);
        com.zlp.std.StdOut.println();

        com.zlp.std.StdOut.print("Type a double: ");
        double c = StdIn.readDouble();
        com.zlp.std.StdOut.println("Your double was: " + c);
        StdOut.println();
